                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                                        ...
                                        <div class="card-tools float-left">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <button class="btn btn-success btn-sm ml-auto" @click="openAddModal"
                                                    v-if="can('create registrar')"><i class="fas fa-user-plus"></i>
                                                    Add</button>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-head-fixed text-nowrap">
                                            ...
                                            <tbody>
                                                <tr v-for="(data, index) in option_chat.data" :key="index">
                                                    <td v-if="data.is_server == null">{{ data.name }}
                                                    </td>
                                                    <td v-else>Server</td>
                            ...
                            <view-modal @getData="getData" :row="selected_chat" :page="current_page"></view-modal>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
import viewModal from "./ViewChat.vue";
export default {
    components: {
        viewModal,
    },
